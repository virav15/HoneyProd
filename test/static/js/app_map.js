...
let satelliteMap = L.tileLayer(
    ...
    "access_token=pk.eyJ1IjoidmlyYWwxNSIsImEiOiJjancxN2E5YXAwM3pmNDhvOG42dmI4MXBiIn0.mjqGfOmfA4H4c9p_N7BCrA"
  );
...
L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/outdoors-v10/tiles/256/{z}/{x}/{y}?access_token=" +
  "pk.eyJ1IjoidmlyYWwxNSIsImEiOiJjancxN2E5YXAwM3pmNDhvOG42dmI4MXBiIn0.mjqGfOmfA4H4c9p_N7BCrA").addTo(myMap);
